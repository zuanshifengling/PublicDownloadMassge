...
# """
# normal_link :
#     用于下载普通的链接 ， 如 ：https://issuecdn.baidupcs.com/issue/netdisk/yunguanjia/BaiduNetdisk_7.2.8.9.exe
#     For downloading normal links, such as https:issuecdn.baidupcs.comissuenetdiskyunguanjiaBaiduNetdisk_7.2.8.9.exe
# """
#
# # 导入包   Import the package
# from __future__ import annotations
# import requests  # 下载请求库
# import tqdm  # 进度条
# import multitasking  # 多线程
# import signal  # 多线程
# import retry  # 尝试出错时重试
#
# signal.signal(signal.SIGINT, multitasking.killall)
#
# # 请求头   Request headers
